...
class DataHelper:
    def __init__(self, gz=True, config=None):
        ...
        self.__dev_dire_features__ = None
        self.__probe_dev_features__ = None

        self.__train_examples__ = None
        self.__dev_examples__ = None
        self.__dev_dire_examples__ = None
        self.__probe_dev_examples__ = None

        self.__train_graphs__ = None
        self.__dev_graphs__ = None
        self.__dev_dire_graphs__ = None
        self.__probe_dev_graphs__ = None

        self.__train_example_dict__ = None
        self.__dev_example_dict__ = None
        self.__dev_dire_example_dict__ = None
        self.__probe_dev_example_dict__ = None
    ...
    @property
    def dev_dire_feature_file(self):
        return self.get_feature_file('dev_distractor_dire')
    
    @property
    def probe_dev_feature_file(self):
        return self.get_feature_file('probe_dev_distractor')
    ...
    @property
    def dev_dire_example_file(self):
        return self.get_example_file('dev_distractor_dire')

    @property
    def probe_dev_example_file(self):
        return self.get_example_file('probe_dev_distractor')
    ...
    @property
    def dev_dire_graph_file(self):
        return self.get_graph_file('dev_distractor_dire')

    @property
    def probe_dev_graph_file(self):
        return self.get_graph_file('probe_dev_distractor')
    ...
    @property
    def dev_dire_features(self):
        return self.__get_or_load__('__dev_dire_features__', self.dev_dire_feature_file)
    
    @property
    def probe_dev_features(self):
        return self.__get_or_load__('__probe_dev_features__',self.probe_dev_feature_file)
    ...
    @property
    def dev_dire_examples(self):
        return self.__get_or_load__('__dev_dire_examples__', self.dev_dire_example_file)
    

    @property
    def probe_dev_examples(self):
        return self.__get_or_load__('__probe_dev_examples__',self.probe_dev_example_file)
    ...
    @property
    def dev_dire_graphs(self):
        return self.__get_or_load__('__dev_dire_graphs__', self.dev_dire_graph_file)

    @property
    def probe_dev_graphs(self):
        return self.__get_or_load__('__probe_dev_graphs__',self.probe_dev_graph_file)
    ...
    @property
    def dev_dire_example_dict(self):
        if self.__dev_dire_example_dict__ is None:
            self.__dev_dire_example_dict__ = {e.qas_id: e for e in self.dev_dire_examples}
        return self.__dev_dire_example_dict__
    
    
    @property
    def probe_dev_example_dict(self):
        if self.__probe_dev_example_dict__ is None:
            self.__probe_dev_example_dict__ = {e.qas_id: e for e in self.probe_dev_examples}
        return self.__probe_dev_example_dict__
    ...
    @property
    def dev_dire_feature_dict(self):
        return {e.qas_id:e for e in self.dev_dire_features}
    
    @property
    def probe_dev_feature_dict(self):
        return {e.qas_id:e for e in self.probe_dev_features}
    ...
    def load_dev_dire(self):
        return self.dev_dire_features, self.dev_dire_example_dict, self.dev_dire_graphs
    
    def load_probe_dev(self):
        return self.probe_dev_features,self.probe_dev_example_dict,self.probe_dev_graphs
    ...
    @property
    def dev_dire_loader(self):
        return self.DataIterator(*self.load_dev_dire(),
                                 bsz=self.config.eval_batch_size,
                                 device=self.config.device,
                                 para_limit=self.config.max_para_num,
                                 sent_limit=self.config.max_sent_num,
    ...
    @property
    def probe_dev_loader(self):
        return self.DataIterator(*self.load_probe_dev(),
                                 bsz=self.config.eval_batch_size,
                                 device=self.config.device,
                                 para_limit=self.config.max_para_num,
                                 sent_limit=self.config.max_sent_num,
