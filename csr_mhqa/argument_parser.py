...
def default_train_parser():
    ...
    parser.add_argument("--counterfactual",type=boolean_string,default=False,
                            help="whether to fetch the counterfactual inputs tokens")
    ...
    parser.add_argument("--graph",type=str,default="gat",
                        help="for ablaltion study for gat block: gat, fullyconnected, without_graph")
    parser.add_argument("--use_lstm",type=boolean_string,default=False,
                        help="for ablation study for lstm block")
    parser.add_argument("--use_biattn",type=boolean_string,default=True,
                        help="for ablation study for BiAttention block")
    parser.add_argument("--only_c2q",type=boolean_string,default=False,
                        help="ablation for biattn c2q")
    parser.add_argument("--use_gate",type=boolean_string,default=True,
                        help="ablation for ctx_attention")
    parser.add_argument("--use_graph2ctx",type=boolean_string,default=False,
                        help="whether to add graph2ctx")
    parser.add_argument("--probe",type=boolean_string,default=False,
                        help="whether to evaluate the probe of the dev")

    # eval
    parser.add_argument("--encoder_ckpt", default=None, type=str)
    parser.add_argument("--model_ckpt", default=None, type=str)
    parser.add_argument("--ckpt_num", default=5, type=int)
